...
def add_img(name, desc, source, tag_names):
    img = Image.objects.create(name=name, desc=desc, source=source)
...
add_img('kitten', 'ginger kitten', 'http://dreamatico.com/data_images/kitten/kitten-2.jpg', ['Animal', 'Cat', 'Cute'])
